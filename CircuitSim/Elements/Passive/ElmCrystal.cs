...
namespace Circuit.Elements.Passive {
    class ElmCrystal : ElmComposite {
        ...
        public ElmCrystal() : base(MODEL_STRING, EXTERNAL_NODES) {
        ...
        public ElmCrystal(StringTokenizer st) : base(st, MODEL_STRING, EXTERNAL_NODES) {
            var c1 = (ElmCapacitor)CompElmList[0].Elm;
            ParallelCapacitance = c1.Capacitance;
            var c2 = (ElmCapacitor)CompElmList[1].Elm;
            SeriesCapacitance = c2.Capacitance;
            var i1 = (ElmInductor)CompElmList[2].Elm;
            Inductance = i1.Inductance;
            var r1 = (ElmResistor)CompElmList[3].Elm;
