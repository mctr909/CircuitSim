...
namespace Circuit.Elements.Custom {
    abstract class ChipUI : BaseUI {
        ...
        public class Pin {
            ...
            public Pin(ChipUI elm, int p, int s, string t) {
                mElm = elm;
                pos = p;
                side = s;
                text = t;
        ...
        public ChipUI(Point pos) : base(pos) {
            mNoDiagonal = true;
            setSize(1);
        }

        public ChipUI(Point p1, Point p2, int f) : base(p1, p2, f) {
            mNoDiagonal = true;
            setSize(1);
        }
