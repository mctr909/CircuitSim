...
namespace Circuit {
	public interface IElement {
		int TermCount { get; }
		Point[] NodePos { get; set; }
		int[] Nodes { get; set; }
		double Current { get; set; }
		double VoltageDiff { get; }
		...
		void AllocNodes();
		void SetNodePos(params Point[] node);
		void SetNodePos(PointF pos, params PointF[] node);
		void SetNodePos(PointF[] node, PointF pos);
		...
		void DoIteration();
		void SetCurrent(int n, double c);
