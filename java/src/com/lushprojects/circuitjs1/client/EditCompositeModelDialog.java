...
public class EditCompositeModelDialog extends DialogBox
	...
	boolean createModel() {
		...
		model = CirSim.CIRSIM.getCircuitAsComposite();
		if (model == null)
			return false;
	...
	void createDialog() {
		...
		okButton.addClickHandler(new ClickHandler() {
			public void onClick(ClickEvent event) {
				...
				CirSim.CIRSIM.updateModels();
				CirSim.CIRSIM.needAnalyze(); // will get singular matrix if we don't do this
				closeDialog();
			}
		});
		this.center();
	...
	void drawChip() {
		...
		context.setFillStyle(CirSim.CIRSIM.getBackgroundColor().getHexValue());
