namespace Circuit.Elements.Active {
	class ElmAnalogSwitch : BaseElement {
		...
		public override void Stamp() {
			CircuitElement.row_info[NodeIndex[0] - 1].left_changes = true;
			CircuitElement.row_info[NodeIndex[1] - 1].left_changes = true;
		}
		...
		public override void DoIteration() {
			...
			var rowA = CircuitElement.row_info[NodeIndex[0] - 1].row;
			var rowB = CircuitElement.row_info[NodeIndex[1] - 1].row;
