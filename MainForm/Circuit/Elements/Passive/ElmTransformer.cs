namespace Circuit.Elements.Passive {
	class ElmTransformer : BaseElement {
		...
		protected override void StartIteration() {
			...
			I[CS_PRI] = I[CUR_PRI] + priV * Params[PRI_T] + secV * Params[SEC_T];
			I[CS_SEC] = I[CUR_SEC] + priV * Params[PRI_B] + secV * Params[SEC_B];
		}
		...
		public override void SetVoltage(int n, double v) {
			...
			var priV = V[PRI_T] - V[PRI_B];
			var secV = V[SEC_T] - V[SEC_B];
			I[CUR_PRI] = I[CS_PRI] + priV * Params[PRI_T] + secV * Params[SEC_T];
			I[CUR_SEC] = I[CS_SEC] + priV * Params[PRI_B] + secV * Params[SEC_B];
		}
	}
}
