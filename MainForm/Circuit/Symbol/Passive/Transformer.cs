...
namespace Circuit.Symbol.Passive {
	class Transformer : BaseSymbol {
		...
		public override void Stamp() {
			...
			Element.Params[ElmTransformer.PRI_T] = l2 * deti * hdt;
			Element.Params[ElmTransformer.PRI_B] = -m * deti * hdt;
			Element.Params[ElmTransformer.SEC_T] = -m * deti * hdt;
			Element.Params[ElmTransformer.SEC_B] = l1 * deti * hdt;
			StampConductance(Element.Nodes[ElmTransformer.PRI_T], Element.Nodes[ElmTransformer.PRI_B], Element.Params[ElmTransformer.PRI_T]);
			StampConductance(Element.Nodes[ElmTransformer.SEC_T], Element.Nodes[ElmTransformer.SEC_B], Element.Params[ElmTransformer.SEC_B]);
			StampVCCurrentSource(
				Element.Nodes[ElmTransformer.SEC_T], Element.Nodes[ElmTransformer.SEC_B],
				Element.Nodes[ElmTransformer.PRI_T], Element.Nodes[ElmTransformer.PRI_B], Element.Params[ElmTransformer.PRI_B]);
			StampVCCurrentSource(
				Element.Nodes[ElmTransformer.PRI_T], Element.Nodes[ElmTransformer.PRI_B],
				Element.Nodes[ElmTransformer.SEC_T], Element.Nodes[ElmTransformer.SEC_B], Element.Params[ElmTransformer.SEC_T]);
