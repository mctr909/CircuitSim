...
namespace Circuit.Symbol.Passive {
	class Pot : BaseSymbol {
		...
		public override void Stamp() {
			...
			Element.Params[ElmPot.A] = MaxResistance * pos;
			Element.Params[ElmPot.B] = MaxResistance * (1 - pos);
			StampResistor(Element.Nodes[0], Element.Nodes[2], Element.Params[ElmPot.A]);
			StampResistor(Element.Nodes[2], Element.Nodes[1], Element.Params[ElmPot.B]);
		}
		...
		public override void Draw(CustomGraphics g) {
			...
			if (ControlPanel.ChkShowValues.Checked && Element.Params[ElmPot.A] > 0 && (mFlags & FLAG_SHOW_VALUES) != 0) {
				...
				/* draw units */
				var s1 = TextUtils.Unit(rev ? Element.Params[ElmPot.B] : Element.Params[ElmPot.A], "");
				var s2 = TextUtils.Unit(rev ? Element.Params[ElmPot.A] : Element.Params[ElmPot.B], "");
		...
		public override void GetInfo(string[] arr) {
			...
			arr[2] = "R1：" + TextUtils.Unit(Element.Params[ElmPot.A], "Ω");
			arr[3] = "R2：" + TextUtils.Unit(Element.Params[ElmPot.B], "Ω");
