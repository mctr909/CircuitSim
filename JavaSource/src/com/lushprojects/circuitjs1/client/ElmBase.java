...
public abstract class ElmBase implements Editable {
	...
	public void drawCenteredText(CustomGraphics g, String s, int x, int y, boolean cx) {
	...
	public void drawCoil(CustomGraphics g, int hs, Point p1, Point p2,
			double v1, double v2) {
	...
	public Polygon getSchmittPolygon(float gsize, float ctr) {
	...
	public void setPowerColor(CustomGraphics g, boolean yellow) {
	...
	protected static void drawThickPolygon(CustomGraphics g, Polygon p) {
		drawThickPolygon(g, p.xpoints, p.ypoints, p.npoints);
	}

	protected static void drawPolygon(CustomGraphics g, Polygon p) {
