...
package com.lushprojects.circuitjs1.client;
	...
	void drawSegment(CustomGraphics g, int x1, int y1, int x2, int y2) {
	    drawSegment(g, new Point(x1, y1), new Point(x2, y2));
	}
	void drawSegment(CustomGraphics g, Point p1, Point p2) {
	    g.context.beginPath();
	    Point p3 = new Point();
	    Point p4 = new Point();
	    Point p5 = new Point();
	...
	void drawDecimal(CustomGraphics g, int x, int y) {
	    int sp = 7;
	    g.context.beginPath();
	...
	void setColor(CustomGraphics g, int p) {
	    if (diodeDirection == 0) {
