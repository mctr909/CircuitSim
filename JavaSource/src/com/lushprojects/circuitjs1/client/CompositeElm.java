...
public abstract class CompositeElm extends ElmBase {
	...
	compElmList = new Vector<ElmBase>();
	...
	while (modelLinet.hasMoreTokens()) {
	    ...
	    ElmBase newce = CirSim.constructElement(ceType, 0, 0);
	    if (stIn!=null) {
