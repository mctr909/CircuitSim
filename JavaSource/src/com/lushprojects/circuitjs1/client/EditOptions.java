...
class EditOptions implements Editable {
	...
	public EditInfo getEditInfo(int n) {
		...
		if (n == 3)
			return new EditInfo("Positive Color", ElmBase.positiveColor.getHexValue());
		if (n == 4)
			return new EditInfo("Negative Color", ElmBase.negativeColor.getHexValue());
		if (n == 5) {
	...
	public void setEditValue(int n, EditInfo ei) {
		...
		if (n == 3) {
			...
			ElmBase.positiveColor = new Color(txt);
		...
		if (n == 4) {
			...
			ElmBase.negativeColor = new Color(txt);
			ElmBase.setColorScale();
		}
		if (n == 5) {
